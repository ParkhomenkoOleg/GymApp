...
export default function Generator(props) {
    ...
    return (
        <SectionWrapper id={'generate'} header={'generate your workout'} title={['It\'s', 'Huge', 'o\'clock']}>
            ...
            <Header index={'02'} title={'Lock on targets'} description={'Select the muscle for annihilation.'} />
            <div className='bg-slate-950 border border-solid border-blue-400 rouded-lg flex flex-col'>
